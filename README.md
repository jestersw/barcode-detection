...
<p align="center">
  <img width="787" alt="Схема размещения камер в сканирующем тоннеле" src="https://github.com/user-attachments/assets/f431cf3f-f5bb-4088-a764-203c6f46e0e9" />
  <br/>
  <em>Вид сверху: 6 камер покрывают все грани коробки - 1 сверху, 4 боковые под 45° (каждая ловит 2-3 грани с перекрытием), 1 снизу через разрыв ленты.</em>
</p>
